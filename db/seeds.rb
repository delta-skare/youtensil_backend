...
Profile.create(user_id: user1.id, username: 'testuser2', food_types: 'landfish', bio: "I'm also not real...", image: "http://s3.amazonaws.com/pix.iemoji.com/images/emoji/apple/ios-11/256/smirking-face.png", following: "")
